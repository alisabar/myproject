...
class MyMainActivityMusicRunnable implements Runnable, MediaPlayer.OnCompletionListener {
    Context appContext;
static     MediaPlayer mPlayer;
    boolean musicIsPlaying = false;

    public MyMainActivityMusicRunnable(Context c) {
    ...
    private MediaPlayer createMediaPlayer() {
         mPlayer = MediaPlayer.create(appContext, R.raw.mainmusic);
